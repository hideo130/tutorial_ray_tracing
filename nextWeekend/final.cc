...
hittable_list scene1(){
    ...
    point3 center(-0.5,0.2,1);
    auto center2 = center + vec3(0.3, 0.2, 1);
    world.add(make_shared<moving_sphere>(center, center2, 0, 0.5, 0.2, sphere_material));
    
    center = vec3(0.5,0,1);
    center2 = center + vec3(0.3, 0.2, 1);
